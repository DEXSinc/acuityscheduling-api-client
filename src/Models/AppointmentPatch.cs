...
namespace AcuityScheduling.API.Models
{
    ...
    {
        /// <summary>Client first name, may not be removed.</summary>
        [Newtonsoft.Json.JsonProperty("firstName", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string FirstName { get; set; }
    
        /// <summary>Client last name, may not be removed.</summary>
        ...
        /// <summary>Client phone. May not be removed for clients depending on account settings, optional for admins.</summary>
        ...
        /// <summary>Client email. May not be removed for clients, optional for admins.</summary>
